...
int main()
{
    ...
    stbi_image_free(data);
    ShaderTriangle.use();
    ShaderTriangle.setInt("texture1", 0);
    ShaderTriangle.setInt("ourTexture2", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ShaderTriangle.setMat4("projection", projection);

        glm::mat4 view = camera.GetViewMatrix();
        ShaderTriangle.setMat4("view", view);
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            ShaderTriangle.setMat4("model", model);
